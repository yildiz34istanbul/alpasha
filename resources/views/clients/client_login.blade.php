...
<body style="font-family: 'Cairo', sans-serif">
 ...
 login-->
        ...
        <section class="height-100vh d-flex align-items-center page-section-ptb login"
            style="background-image: url(/../assets/images/lo.jpg); background-repeat: no-repeat;
    ...
    font-size: 17px;" class="mb-20 text-white"> 
                    ...
                    <div class="col-lg-4 col-md-6 bg-white">
                        ...
                        @if(session('error'))
                            ...
                            <h3 class="mb-30" style="font-family: 'Cairo', sans-serif">   {{ __('track.Customer_Login') }}</h3>

                            <form method="POST" action="{{ route('client.login') }}">
                                @csrf

                                <div class="section-field mb-20">
                                    <label class="mb-10" for="name" ><span style="font-family:'Cairo', sans-serif">*{{ __('track.email') }}</span></label>
                                ...
                                <div class="section-field mb-20">
                                    <label class="mb-10" for="Password" style="font-family: 'Cairo';">*{{ __('track.password') }} </label>
                                ...
                                <div class="section-field">
                                    <div class="remember-checkbox mb-30">
                                        ...
                                        <a href="#" class="float-right">{{ __('track.Forgot_password') }} </a>
                                    </div>
                                </div>
                                <button class="button"><span> {{ __('track.Login') }}</span><i class="fa fa-check"></i></button>
                            </form>
                        </div>
                    </div>
                </div>

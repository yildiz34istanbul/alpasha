...
<ul class="nav navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown ">
        ...
        <div id="notify-menu" class="dropdown-menu dropdown-menu-right dropdown-big dropdown-notifications">
            <div class="dropdown-header notifications">
                <strong style="font-family: 'Cairo', sans-serif;">{{ __('track.Notifications') }}</strong>
            ...
            @if(count(Auth::guard('client')->user()->unreadNotifications)!=0)
                   ...
                   <small class="float-right text-muted time"></small> </a>
                                ...
                                <h4 class="badge badge-dark font-weight-bold" style="font-family: 'Cairo', sans-serif;">{{ __('track.all_Notifications') }}</h4>
                                   </a>
                    </div>
                    </div>
            @endif
    ...
    <li class="nav-item dropdown mr-30">
        ...
        <div class="dropdown-menu dropdown-menu-right">
            <div class="dropdown-header">
                <div class="media">
                    <div class="media-body">
                        ...
                        <h5 class="mt-0 mb-0" style="font-family: 'Cairo', sans-serif;">{{ Auth::guard('client')->user() ? Auth::guard('client')->user()->name : '' }}</h5>
            ...
            <a class="dropdown-item" href="{{ route('ClientProfile.View') }}" style="font-family: 'Cairo', sans-serif;"><i class="text-warning ti-user"></i>{{ __('track.Profile') }}</a>
            <a class="dropdown-item" href="{{ route('Clientpassword.view') }}" style="font-family: 'Cairo', sans-serif;"><i class="text-warning ti-marker-alt"></i>{{ __('track.change_password') }}</a>
			<a class="dropdown-item" href="{{ route('Delete.Account') }}" style="font-family: 'Cairo', sans-serif;"><i class="text-danger ti-close"></i>{{ __('track.delete_account') }}</a>
            <div class="dropdown-divider"></div>
        <!--  <a href="{{ route('client.logout') }}"><span><i class="fas fa-unlock-alt"></i></span> Logout</a></li> -->
            <a class="dropdown-item" href="{{ route('client.logout') }}" style="font-family: 'Cairo', sans-serif;" ><i class="text-danger ti-unlock"></i>{{ __('track.logout') }}</a>
